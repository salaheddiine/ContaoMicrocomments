...
if(isset($GLOBALS['TL_DCA']['tl_calendar_events']) && is_array($GLOBALS['TL_DCA']['tl_calendar_events']))
{
    /**
     ...
     */
    $GLOBALS['TL_DCA']['tl_calendar_events']['fields']['addMicroComments'] = array
    (
        'label'                   => &$GLOBALS['TL_LANG']['tl_calendar_events']['addMicroComments'],
        'exclude'                 => true,
        'filter'                  => true,
        'inputType'               => 'checkbox',
    ...
    $GLOBALS['TL_DCA']['tl_calendar_events']['fields']['com_micro_order'] = array
    (
        'label'                   => &$GLOBALS['TL_LANG']['tl_calendar_events']['com_micro_order'],
        'default'                 => 'descending',
        'exclude'                 => true,
        'inputType'               => 'select',
    ...
    $GLOBALS['TL_DCA']['tl_calendar_events']['fields']['com_micro_perPage'] = array
    (
        'label'                   => &$GLOBALS['TL_LANG']['tl_calendar_events']['com_micro_perPage'],
        'default'                 => 0,
        'exclude'                 => true,
        'inputType'               => 'text',
    ...
    $GLOBALS['TL_DCA']['tl_calendar_events']['fields']['com_micro_template'] = array
    (
        'label'                   => &$GLOBALS['TL_LANG']['tl_calendar_events']['com_micro_template'],
     ...
     * @package    Controller
     */
    class tl_calendar_events_microcomments extends Backend
    {
        ...
        public function getCommentsTemplates(DataContainer $dc)
        {
            ...
            // Get the page ID
            $objArticle = $this->Database->prepare("SELECT pid FROM tl_calendar_events WHERE id=?")
                                         ->limit(1)
                                         ->execute($intPid);
