 ...
 */
$GLOBALS['TL_DCA']['tl_content']['fields']['com_micro_order'] = array
(
...
$GLOBALS['TL_DCA']['tl_content']['fields']['com_micro_perPage'] = array
(
...
$GLOBALS['TL_DCA']['tl_content']['fields']['com_micro_template'] = array
(
...
/**
 * Class tl_content_microcomments
 *
 ...
 * @package    Controller
 */
class tl_content_microcomments extends Backend
{
    ...
    public function getCommentsTemplates(DataContainer $dc)
    {
        ...
        // Get the page ID
        $objArticle = $this->Database->prepare("SELECT pid FROM tl_content WHERE id=?")
                                     ->limit(1)
                                     ->execute($intPid);
