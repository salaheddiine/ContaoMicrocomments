...
/**
 * Class ContentMicroComments
 *
 * @copyright  Dominik Zogg 2011
 * @author     Dominik Zogg <http://www.dominik-zogg.ch>
 * @package    Controller
 */
class ContentMicroComments extends ContentElement
{
    ...
    protected function compile()
    {
        ...
        $this->MicroComments->addMicroCommentsToTemplate($this->Template, $objConfig, 'tl_content', $this->id, $GLOBALS['TL_ADMIN_EMAIL']);
    }
}