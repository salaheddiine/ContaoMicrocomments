 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_calendar_events']['addMicroComments']       = array('Kleinst-Kommentare aktivieren', 'Wenn Sie diese Option wählen, wird dem Event das Kleinstkommentare Content Modul hinzugefügt.');
...
$GLOBALS['TL_LANG']['tl_calendar_events']['com_micro_groups']       = array('Erlaubte Mitgliedergruppen', 'Diese Gruppen dürfen auf die Kleinst-Kommentate zugreifen.');


/**
 * Legends
 */
$GLOBALS['TL_LANG']['tl_calendar_events']['microcomment_legend']    = 'Kleinst-Kommentare';
